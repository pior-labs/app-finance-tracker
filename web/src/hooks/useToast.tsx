  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="-mr-1 -mt-1 flex h-6 w-6 shrink-0 cursor-pointer items-center justify-center rounded-full border-0 bg-transparent text-xs text-ink-3 transition-colors hover:bg-white/60 hover:text-ink"
      >
        ✕
      </button>
    </div>
...
const VARIANT_STYLES: Record<ToastVariant, { background: string; icon: string; iconBg: string; iconShadow: string }> = {
  success: {
